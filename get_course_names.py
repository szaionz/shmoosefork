...
def main():
    ...
    #         f.write(course_name)
    with open(os.path.join(COURSE_DATA_DIR, "course_names.min.js"), 'w', encoding='utf-8') as f:
        f.write(f"var course_names_mapper={ujson.dumps(course_names, ensure_ascii=False)};")
